...
def load_enemies():
    ...
    enemy_dict["enemy_2"] = (40, 2, 300, "heroin_shadow.png", {items_dict["scythe"]: 50, items_dict["hat"]: 30}, {material_dict["iron"]: 50, material_dict["steel"]: 30})
    enemy_dict["enemy_3"] = (60, 2, 600, "heroin_shadow.png", {items_dict["voodoo"]: 50, items_dict["ghost"]: 30}, {material_dict["platinum"]: 50, material_dict["diamond"]: 30})
